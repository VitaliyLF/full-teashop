...
export class OrderDto {
  ...
  // указываем что items(в нашем случае это заказы) должны быть массивом
  @IsArray({ message: 'В заказе нет ни одного товара' })
  // each: true Говорит валидатору: каждый элемент массива items должен быть валидирован как отдельный объект DTO
