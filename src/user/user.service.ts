...
export class UserService {
  ...
  async getById(id: string) {
    ...
    // дальше мы получается в призме ищем модель юзера и через метод findUnique ищет ровно одну запись в таблице по уникальному полю или составному уникальному ключу.
